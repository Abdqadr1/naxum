...
<div class="container">
    <form method="post" action="{{route('search')}}">
        ...
        <div class="row justify-content-around">
            <div class="col-8">
                <div class="mb-3 row col">
                    ...
                    <div class="col-sm-7 position-relative">
                        <input type="text" name="name" class="form-control" id="distributor" value="{{ old('name') }}" 
                            placeholder="Search by ID, Username, First Name, Last Name" required>
            ...
            <div class="col-4">
                <div class="mb-3 col">
                    <label for="staticEmail" class="col-sm-9 col-form-label fw-bold">TOTAL COMMISSION:  {{ sprintf("%0.2f", $total_commission); }}</label>
                </div>
            </div>
        </div>
        <div class="row justify-content-around">
